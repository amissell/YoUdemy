...
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="en">
  <head>
    ...
    <title>Teacher Dashboard - YoUdemy Dashboard</title>
    <link
                  ...
                  <table class="w-full whitespace-no-wrap">
                    <thead>
                      <tr class="text-xs font-semibold tracking-wide text-left text-gray-500 uppercase border-b dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                        ...
                        <th class="px-4 py-3">Students Enrolled</th>
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                      ...
                      <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3">
                          <a href="#" class="text-purple-600 hover:underline">Edit</a>
                          <a href="#" class="ml-2 text-red-600 hover:underline">Delete</a>
                          <a href="#" class="ml-2 text-blue-600 hover:underline">View Enrollments</a>
                        </td>
                      </tr>
